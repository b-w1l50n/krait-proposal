...
`+
source('krait/deliverables/KRAIT_modem_feasibility_report.md; krait/bom/proposal_revision/cost_detail.csv; krait/deliverables/KRAIT_contractor_response.md','The current planning direction distinguishes the sub-$300 assembled-PCB electronics target from the approximately $750 average complete-modem target including acoustic hardware. Some configurations may reach $1,500 depending on transducer selection. Detailed parts and implementation files remain private.')}
];
